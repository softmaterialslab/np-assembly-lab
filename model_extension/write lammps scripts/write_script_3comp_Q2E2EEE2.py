...
sigmahc_V1 = 5.15
sigmahc_V2 = 4.75
sigmahc_V3 = 4.45    #attention! this is usually the smaller value!
...
plt.plot(r, unet1d, label = 'EEE2, $\sigma_{hc}$=%f' %sigmahc_V1)
plt.plot(r, unet2d, label = 'E2, $\sigma_{hc}$=%f' %sigmahc_V2)
plt.plot(r, unet3d, label = 'Q2, $\sigma_{hc}$=%f' %sigmahc_V3)
