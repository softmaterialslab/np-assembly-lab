...
#charges in e:
Q1 = -2085    #charge of VLP1 usually the highest-charge
Q2 = -1500    #charge of VLP2
...
sigmahc13 = 5.15
sigmahc23 = 4.75    #attention! this is usually the smaller value!
...
plt.plot(r, unet13, label = 'EEE2, $\sigma_{hc}$=%f' %sigmahc13)
plt.plot(r, unet23, label = 'E2, $\sigma_{hc}$=%f' %sigmahc23)
...
restart		1000000	outfiles/assemblyRestart.*	# creates restart files throughout run
run		20000000
