...
# E2+Q2 concentrations:    0.3 0.275 0.245 0.2 0.18 0.16 0.125 0.1 0.04 
# E2+K2 concentrations:    0.3 0.275 0.245 0.2 0.15 0.125 0.1 0.075 0.04
...
if [ "$TWOCOMP" = "EEE2E2" ]; then
  ...
  for USERSALTCONC in 0.35 0.325 0.31 #0.6 0.57 0.55 0.5 0.4 0.3 0.27 0.245 0.1 0.04 
  do      
  ...
  USERVLP2CHARGE="-1165"
  USERSIGMAHC2RAW="4"
  for USERSALTCONC in 0.3 0.275 0.245 0.2 0.18 0.16 0.125 0.1 0.04 
  do        
    if [ "$USERSALTCONC" = 0.6 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.0536841166259483"
  ...
  USERVLP1="E2"
  USERVLP2="K2"
  for USERSALTCONC in 0.3 0.275 0.245 0.2 0.15 0.125 0.1 0.075 0.04
  do
    if [ "$USERSALTCONC" = 0.6 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.0536841166259483"
