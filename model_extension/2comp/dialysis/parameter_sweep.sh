...
if [ "$TWOCOMP" = "EEE2E2" ]; then
  ...
  do
    if [ "$USERSALTCONC" = 0.6 ]; then
        ...
        USERVLPLinkerEScutoff="0.648826250482191"
        USERLinkerEScutoff="0.1998572714414298" 
    elif [ "$USERSALTCONC" = 0.19 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.1086890671209977"
        USERVLPLinkerEScutoff="0.6515050630063006"
        USERLinkerEScutoff="0.20235749646393209"     
    elif [ "$USERSALTCONC" = 0.18 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.112439404654751"
        USERVLPLinkerEScutoff="0.654719638035232"
  ...
  do
    if [ "$USERSALTCONC" = 0.6 ]; then
        ...
        USERVLPLinkerEScutoff="0.6657920631348848"
        USERLinkerEScutoff="0.21468003407483605" 
    elif [ "$USERSALTCONC" = 0.13 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.1367273048733444"
        USERVLPLinkerEScutoff="0.6752572007200719"
        USERLinkerEScutoff="0.222895059148772"     
    elif [ "$USERSALTCONC" = 0.125 ]; then
        echo $USERSALTCONC
        USERVLPEScutoff="1.1399418799022758"
        USERVLPLinkerEScutoff="0.6781146007457888"
