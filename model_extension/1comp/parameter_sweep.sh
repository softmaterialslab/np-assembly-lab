...
# E2 concentrations:    0.3 0.28 0.25 0.24 0.22 0.2 0.15 0.1 0.04 0.01 
# Q2 concentrations:    0.2 0.16 0.15 0.14 0.12 0.10 0.08 0.06 0.04 0.01
# K2 concentrations:    0.2 0.15 0.12 0.1 0.08 0.075 0.07 0.06 0.04 0.01
...
if [ "$USERVLP" = "EEE2" ]; then
  ...
  USERVLPCHARGE="-1500"
  USERSIGMAHCRAW="4.75"
  for USERSALTCONC in 0.3 0.28 0.25 0.24 0.22 0.2 0.15 0.1 0.04 0.01
  do
  #copy lines from python generator here:
  ...
  USERVLPCHARGE="-1080"
  USERSIGMAHCRAW="4.45"
  for USERSALTCONC in 0.2 0.16 0.15 0.14 0.12 0.10 0.08 0.06 0.04 0.01
  do
  #copy lines from python generator here:
  ...
  USERVLPCHARGE="-600"
  USERSIGMAHCRAW="4.15"
  for USERSALTCONC in 0.2 0.15 0.12 0.1 0.08 0.075 0.07 0.06 0.04 0.01
  do
  #copy lines from python generator here:
    if [ "$USERSALTCONC" = 0.2 ]; then
        echo $USERSALTCONC
